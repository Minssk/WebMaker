...
<body>
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            ...
            <img src="<c:url value='/images/webpack/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;공공IPIN 실명확인</td>
            </tr>
        </table>
        <table width="717" border="0"  cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <tr>
                    <!-- 실명확인 
	                <td align="right"><img src="<c:url value='/images/webpack/com/cmm/btn/bu2_left.gif' />" width="8" height="20" alt="버튼이미지"></td>
	                <td background="<c:url value='/images/webpack/com/cmm/btn/bu2_bg.gif' />" class="text_left" nowrap>
	                    <a href="javascript:fnGpinCnfirm();"><spring:message code="button.realname" /></a>
	                </td>
	                <td align="left"><img src="<c:url value='/images/webpack/com/cmm/btn/bu2_right.gif' />" width="8" height="20" alt="버튼이미지"></td>
	                -->
