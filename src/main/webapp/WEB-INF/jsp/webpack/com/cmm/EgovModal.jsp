...
<link type="text/css" rel="stylesheet" href="<c:url value='/css/webpack/com/cmm/modal.css' />">
<script src="<c:url value='/js/webpack/com/cmm/modal.js' />"></script>
<%} %>
<!-- The Modal -->
<div id="<%=EgovWebUtil.clearXSSMaximum(sModelName) %>" class="modal">
	...
	<div class="modal-content">
		<div class="modal-header">
			<span class="close"><img src="<c:url value='/images/webpack/com/cmm/btn/btn_close.png'/>" /></span>
