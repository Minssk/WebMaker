...
<link rel="stylesheet" href="<c:url value='/css/webpack/com/com.css' />" type="text/css">
<script language='javascript' src='/js/webpack/com/uat/uia/EgovGpkiVariables.js' />'></script>
<script language='javascript' src='/js/webpack/com/uat/uia/EgovGpkiInstall.js' />'></script>
<script language='javascript' src='/js/webpack/com/uat/uia/EgovGpkiFunction.js' />'></script>
...
<table width="303" border="0" cellspacing="8" cellpadding="0">
     ...
     <tr>
	<td width="40%"class="title_left"><img src="<c:url value='/images/webpack/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle" alt="제목아이콘이미지">&nbsp;인증서 DN 추출</td>
     </tr>
     <tr>
	<td width="303" height="210" valign="top" style="background-image: url(/images/webpack/com/uat/uia/login_bg01.gif);">
		...
		<table>
		  <tr>
			  ...
			  <tr>
				...
				<td><img src="<c:url value='/images/webpack/com/cmm/btn/bu2_left.gif' />" width="8" height="20" alt="버튼이미지"></td>
				<td background="<c:url value='/images/webpack/com/cmm/btn/bu2_bg.gif' />" class="text_left" nowrap><center><a href="javascript:LoginEmbedded(document.GpkiLoginForm);">DN값 추출</a></center></td>
				<td><img src="<c:url value='/images/webpack/com/cmm/btn/bu2_right.gif' />" width="8" height="20" alt="버튼이미지"></td>
              ...
              <tr>
		       ...
		       <td><img src="<c:url value='/images/webpack/com/cmm/btn/bu2_left.gif' />" width="8" height="20" alt="버튼이미지"></td>
		       <td background="<c:url value='/images/webpack/com/cmm/btn/bu2_bg.gif' />" class="text_left" nowrap><center><a href="javascript:sendDn();">DN값 전달</a></center></td>
		       <td><img src="<c:url value='/images/webpack/com/cmm/btn/bu2_right.gif' />" width="8" height="20" alt="버튼이미지"></td>
	          </tr>
            </table>
		  </tr>
