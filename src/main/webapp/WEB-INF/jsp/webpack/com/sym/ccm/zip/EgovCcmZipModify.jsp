...
<h1>
  ...
  <c:set var="titleRdmn"><spring:message code="comSymCcmZip.zipVO.rdmnUpdate"/></c:set>
    <c:if test="${searchList == '1'}">
     <img src="<c:url value='/images/webpack/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle">&nbsp;${titleZip }</h1></td>
    </c:if>
    <c:if test="${searchList == '2'}">
     <img src="<c:url value='/images/webpack/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle">&nbsp;${titleRdmn }</h1></td>
    </c:if>
