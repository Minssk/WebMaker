...
<%--
  ...
  */
  /* Image Path 설정 */
  //String imagePath_icon   = "/images/webpack/com/sym/prm/icon/";
  //String imagePath_button = "/images/webpack/com/sym/prm/button/";
--%>
...
<c:set var="ImgUrl" value="/images/webpack/com/sym/prm/"/>
<c:set var="CssUrl" value="/css/webpack/com/sym/prm/"/>
<html lang="ko">
<head>
...
function initCalendar(){
	...
	$("#rqesterDe").datepicker( 
	        {dateFormat:'yy-mm-dd'
	         , showOn: 'button'
	         , buttonImage: '<c:url value='/images/webpack/com/cmm/icon/bu_icon_carlendar.gif'/>'  
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<img src="<c:url value='/images/webpack/com/cmm/icon/search2.gif' />" alt='(<spring:message code="comSymPrm.programChangRequstStre.searchProgrmFileNm"/>)' width="15" height="15" /></a><!-- 프로그램파일명 검색 -->
