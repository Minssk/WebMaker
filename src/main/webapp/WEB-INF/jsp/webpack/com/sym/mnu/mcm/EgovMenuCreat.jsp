...
<%
  ...
  */
  ...
  /* Image Path 설정 */
//  String imagePath_icon   = "/images/webpack/com/sym/mnu/mcm/icon/";
//  String imagePath_button = "/images/webpack/com/sym/mnu/mcm/button/";
%>
<html lang="ko">
<head>
...
<script language="javascript1.2" type="text/javaScript" src="<c:url value='/js/webpack/com/sym/mnu/mcm/EgovMenuCreat.js' />"></script>
...
<%-- <table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  ...
  <h1><img src="<c:url value='/images/webpack/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" alt="">&nbsp;메뉴생성</h1></td>
  <td width="10%"></td>
  <td width="25%"></td>
  <th width="25%">
