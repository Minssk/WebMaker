...
<script type="text/javascript" src="<c:url value='/js/webpack/com/sym/cal/EgovCalPopup.js' />" ></script>
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<a href="#noscript" onclick="fn_egov_NormalCalendar(document.restde, document.restde.restdeDe, document.restde.vrestdeDe); return false;"><img src="<c:url value='/images/webpack/com/cmm/icon/bu_icon_carlendar.gif' />" alt="달력창팝업버튼이미지"/></a>
			</td>
		</tr>
		<tr>
