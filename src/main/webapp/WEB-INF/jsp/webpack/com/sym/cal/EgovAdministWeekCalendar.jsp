...
<form name="administWeekCalendar" action ="<c:url value='/sym/cal/EgovAdministWeekCalendar.do'/>" method="post">
	...
	<table width="700" cellpadding="8" class="table-search" border="0">
	  <tr>
	    <td width="200" class="title_left"><img src="<c:url value='/images/webpack/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle" alt="제목아이콘이미지">&nbsp;행정달력 주간</td>
	  	<td>
