package webpack.com.sym.mnu.stm.web;
...
import webpack.com.sym.mnu.stm.service.EgovSiteMapngService;
import webpack.com.sym.mnu.stm.service.SiteMapngVO;
...
public class EgovSiteMapngController {
    ...
    public String selectSiteMapng(
    	...
    	if(resultVO == null){
    		...
    		return "webpack/com/sym/mnu/stm/EgovSiteMapng";
    	}
