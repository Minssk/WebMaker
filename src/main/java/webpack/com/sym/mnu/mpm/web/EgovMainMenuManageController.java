...
public class EgovMainMenuManageController {
    ...
    public String selectMainMenu(
		...
		if (!(user == null ? "" : EgovStringUtil.isNullToString(user.getId())).equals("")) {
        	// 메인 페이지 이동
	    		return "webpack/com/EgovMainView";
        } else {
        	// 오류 페이지 이동
        	return "webpack/com/cmm/error/egovError";
        }
    }
