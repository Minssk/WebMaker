package webpack.com.sym.mnu.mpm.web;
...
import webpack.com.sym.mnu.mpm.service.EgovMenuManageService;
import webpack.com.sym.mnu.mpm.service.MenuManageVO;
...
public class EgovMenuManageController {
	...
	public String selectMenuManage(
		...
		return "webpack/com/sym/mnu/mpm/EgovMenuDetailSelectUpdt";
	}
	...
	public String selectMenuManageList(
		...
		return "webpack/com/sym/mnu/mpm/EgovMenuManage";
	}
	...
	public String insertMenuManage(
		...
		if (sCmd.equals("insert")) {
			...
			if (bindingResult.hasErrors()) {
				sLocationUrl = "webpack/com/sym/mnu/mpm/EgovMenuRegist";
				return sLocationUrl;
			}
	...
	public String selectMenuList(
		...
		//        model.addAttribute("resultMsg", resultMsg);
		return "webpack/com/sym/mnu/mpm/EgovMenuList";
	}
	...
	public String insertMenuList(
		...
		beanValidator.validate(menuManageVO, bindingResult);
		if (bindingResult.hasErrors()) {
			sLocationUrl = "webpack/com/sym/mnu/mpm/EgovMenuList";
			return sLocationUrl;
		}
	...
	public String selectMenuListMvmn(
		...
		List<?> list_menulist = menuManageService.selectMenuList();
		model.addAttribute("list_menulist", list_menulist);
		return "webpack/com/sym/mnu/mpm/EgovMenuMvmn";
	}
	...
	public String selectMenuListMvmnNew(
		...
		List<?> list_menulist = menuManageService.selectMenuList();
		model.addAttribute("list_menulist", list_menulist);
		return "webpack/com/sym/mnu/mpm/EgovMenuMvmnNew";
	}
	...
	public String menuBndeAllDelete(
		...
		resultMsg = egovMessageSource.getMessage("success.common.delete");
		model.addAttribute("resultMsg", resultMsg);
		return "webpack/com/sym/mnu/mpm/EgovMenuBndeRegist";
	}
	...
	public String menuBndeRegist(
		...
		if (sCmd.equals("bndeInsert")) {
			...
			sLocationUrl = "webpack/com/sym/mnu/mpm/EgovMenuBndeRegist";
			model.addAttribute("resultMsg", resultMsg);
		} else {
			sLocationUrl = "webpack/com/sym/mnu/mpm/EgovMenuBndeRegist";
		}
