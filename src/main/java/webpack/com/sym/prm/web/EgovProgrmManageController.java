package webpack.com.sym.prm.web;

import java.util.List;
import java.util.Map;

import webpack.com.cmm.ComDefaultVO;
import webpack.com.cmm.EgovMessageSource;
...
import webpack.com.cop.ems.service.EgovSndngMailRegistService;
import webpack.com.cop.ems.service.SndngMailVO;
import webpack.com.sym.prm.service.EgovProgrmManageService;
import webpack.com.sym.prm.service.ProgrmManageDtlVO;
import webpack.com.sym.prm.service.ProgrmManageVO;
import webpack.com.utl.fcc.service.EgovStringUtil;
...
public class EgovProgrmManageController {
    ...
    public String selectProgrm(
    	...
    	if(!isAuthenticated) {
        	...
        	return "webpack/com/uat/uia/EgovLoginUsr";
    	}
        ...
        return "webpack/com/sym/prm/EgovProgramListDetailSelectUpdt";
    }
    ...
    public String selectProgrmList(
        ...
        model.addAttribute("paginationInfo", paginationInfo);
      	...
      	return "webpack/com/sym/prm/EgovProgramListManage";
    ...
    public String insertProgrmList(
        ...
        if(sCmd.equals("insert")){
			...
			if (bindingResult.hasErrors()){
				sLocationUrl = "webpack/com/sym/prm/EgovProgramListRegist";
				return sLocationUrl;
			}
    ...
    public String selectProgrmChangeRequstList(
        ...
        model.addAttribute("paginationInfo", paginationInfo);
         ...
         return "webpack/com/sym/prm/EgovProgramChangeRequst";
    }
    ...
    public String selectProgrmChangeRequst(
         ...
         return "webpack/com/sym/prm/EgovProgramChangRequstDetailSelectUpdt";
    }
    ...
    public String insertProgrmChangeRequst(
        ...
        if(sCmd.equals("insert")){
			...
			if (bindingResult.hasErrors()){
				sLocationUrl = "webpack/com/sym/prm/EgovProgramChangRequstStre";
				return sLocationUrl;
			}
    ...
    public String selectProgrmChangeRequstProcessList(
         ...
         return "webpack/com/sym/prm/EgovProgramChangeRequstProcess";
    }
    ...
    public String selectProgrmChangRequstProcess(
         ...
         model.addAttribute("progrmManageDtlVO", resultVO);
         return "webpack/com/sym/prm/EgovProgramChangRequstProcessDetailSelectUpdt";
    }
    ...
    public String selectProgrmChgHstList(
         ...
         return "webpack/com/sym/prm/EgovProgramChgHst";
    }
    ...
    public String selectProgramChgHstListDetail(
         ...
         return "webpack/com/sym/prm/EgovProgramChgHstDetail";
    }
    ...
    public String selectProgrmListSearch(
        ...
        model.addAttribute("paginationInfo", paginationInfo);
      	...
      	return "webpack/com/sym/prm/EgovFileNmSearch";
    ...
    public String selectProgrmListSearchNew(
        ...
        model.addAttribute("paginationInfo", paginationInfo);
      	...
      	return "webpack/com/sym/prm/EgovFileNmSearchNew";
