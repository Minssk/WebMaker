package webpack.com.uat.uia.onepass.web;
...
import webpack.com.uat.uia.onepass.service.EgovOnepassService;
...
public class EgovOnepassController {
	...
	public String onepassLogin(HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		...
		try {
			...
			return "webpack/com/cmm/error/onepassAccessDenied";
		}
		...
		return "webpack/com/uat/uia/onepass/onepassLogin";
	}
			...
			if (onepassResponse.getType() == TYPE.LOGIN) {
			    ...
			    if (findOnepassUser != null && findOnepassUser.getStatus() == USER_STATUS.USE) {
					...
					if (usedCnt > 0) {
						...
						return "webpack/com/uat/uia/onepass/onepassResult";
