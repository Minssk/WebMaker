...
package webpack.com.uat.uap.web;
...
import webpack.com.uat.uap.service.EgovLoginPolicyService;
import webpack.com.uat.uap.service.LoginPolicy;
import webpack.com.uat.uap.service.LoginPolicyVO;
...
public class EgovLoginPolicyController {
	...
	public String selectLoginPolicyListView() throws Exception {
		return "webpack/com/uat/uap/EgovLoginPolicyList";
	}	
	...
	public String selectLoginPolicy(@RequestParam("emplyrId") String emplyrId, 
		...
		if(vo.getRegYn().equals("N")) 
			return "webpack/com/uat/uap/EgovLoginPolicyRegist";
		else 
			return "webpack/com/uat/uap/EgovLoginPolicyUpdt";
	}
