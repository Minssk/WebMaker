package webpack.com.cmm.config;
...
import webpack.com.cmm.filter.HTMLTagFilter;
import webpack.com.cmm.filter.SessionTimeoutCookieFilter;
import webpack.com.cmm.service.EgovProperties;
import webpack.com.sec.security.filter.EgovSpringSecurityLoginFilter;
import webpack.com.sec.security.filter.EgovSpringSecurityLogoutFilter;
import webpack.com.uat.uap.filter.EgovLoginPolicyFilter;
import webpack.com.utl.wed.filter.CkFilter;
...
public class EgovWebApplicationInitializer implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		//-------------------------------------------------------------
		servletContext.addListener(new webpack.com.cmm.context.EgovWebServletContextListener());
		...
		rootContext.setConfigLocations(new String[] { "classpath*:webpack/spring/com/**/context-*.xml" });
		//rootContext.setConfigLocations(new String[] { "classpath*:webpack/spring/com/context-*.xml","classpath*:webpack/spring/com/*/context-*.xml" });
		rootContext.refresh();
		rootContext.start();
		...
		xmlWebApplicationContext.setConfigLocation("/WEB-INF/config/webpack/springmvc/egov-com-*.xml");
		...
		if("security".equals(EgovProperties.getProperty("Globals.Auth").trim())) {
			...
			//로그인 실패시 반활 될 URL설정
			egovSpringSecurityLoginFilter.setInitParameter("loginURL", "/com/index/webpackLogin.do");
			//로그인 처리 URL설정
		...
		regCkFilter.setInitParameter("properties", "webpack/egovProps/ck.properties");
