...
public class EgovDoubleSubmitHelper {
	...
	public final static String SESSION_TOKEN_KEY = "webpack.double.submit.preventer.session.key";
	
	public final static String PARAMETER_NAME = "webpack.double.submit.preventer.parameter.name";
