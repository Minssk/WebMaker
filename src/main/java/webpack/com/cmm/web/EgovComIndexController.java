...
import webpack.com.cmm.IncludedCompInfoVO;
...
public class EgovComIndexController implements ApplicationContextAware, InitializingBean {
	...
	public String index(ModelMap model) {
		return "webpack/com/cmm/EgovUnitMain";
	}

	@RequestMapping("/EgovTop.do")
	public String top() {
		return "webpack/com/cmm/EgovUnitTop";
	}

	@RequestMapping("/EgovBottom.do")
	public String bottom() {
		return "webpack/com/cmm/EgovUnitBottom";
	}
	...
	public String setContent(ModelMap model) throws Exception {
		...
		return "webpack/com/cmm/EgovUnitContent";
	}
	...
	public String setLeftMenu(ModelMap model) {
		 ...
		 */
		try {
			Class<?> loginController = Class.forName("webpack.com.uat.uia.web.EgovLoginController");
			...
			LOGGER.error("No webpack.com.uat.uia.web.EgovLoginController!!");
		}
		...
		return "webpack/com/cmm/EgovUnitLeft";
	}
	...
	public String egovCSRFAccessDenied() {
		return "webpack/com/cmm/error/csrfAccessDenied";
	}
}
