package webpack.com.uss.umt.web;
...
import webpack.com.uss.umt.service.EgovMberManageService;
import webpack.com.uss.umt.service.MberManageVO;
import webpack.com.uss.umt.service.UserDefaultVO;
import webpack.com.utl.fcc.service.EgovStringUtil;
import webpack.com.utl.sim.service.EgovFileScrty;
...
public class EgovMberManageController {
	...
	public String selectMberList(@ModelAttribute("userSearchVO") UserDefaultVO userSearchVO, ModelMap model) throws Exception {
		...
		return "webpack/com/uss/umt/EgovMberManage";
	}
	...
	public String insertMberView(@ModelAttribute("userSearchVO") UserDefaultVO userSearchVO, @ModelAttribute("mberManageVO") MberManageVO mberManageVO, Model model)
		...
		List<?> mberSttus_result = cmmUseService.selectCmmCodeDetail(vo);
		//그룹정보를 조회 - GROUP_ID정보
		vo.setTableNm("tb_com_orgnztinfo");
		...
		return "webpack/com/uss/umt/EgovMberInsert";
	}
	...
	public String updateMberView(@RequestParam("selectedId") String mberId, @ModelAttribute("searchVO") UserDefaultVO userSearchVO, HttpServletRequest request, Model model) throws Exception {
		...
		return "webpack/com/uss/umt/EgovMberSelectUpdt";
	}
	...
	public String sbscrbMberView(@ModelAttribute("userSearchVO") UserDefaultVO userSearchVO, @ModelAttribute("mberManageVO") MberManageVO mberManageVO,
		...
		return "webpack/com/uss/umt/EgovMberSbscrb";
	}
	...
	public String sbscrbEntrprsMber(Model model) throws Exception {
		...
		return "webpack/com/uss/umt/EgovStplatCnfirm";
	}
	...
	public String updatePassword(ModelMap model, @RequestParam Map<String, Object> commandMap, @ModelAttribute("searchVO") UserDefaultVO userSearchVO,
		...
		return "webpack/com/uss/umt/EgovMberPasswordUpdt";
	}
