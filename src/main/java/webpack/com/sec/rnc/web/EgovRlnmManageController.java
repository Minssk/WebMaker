package webpack.com.sec.rnc.web;
...
import webpack.com.sec.rnc.service.EgovRlnmManageService;
...
//			return "webpack/com/sec/rnc/EgovRlnmCnfirm";
//		}
//
//		try {
...
//		}
		...
		if (nextUrlWhitelist.contains(nextUrl) == false) {
			...
			nextUrl="webpack/com/cmm/egovError";
		}
...
//		return "webpack/com/sec/rnc/EgovRlnmCnfirm";
	...
	public String rlnmPinCnfirm(Model model, @RequestParam Map<String, Object> commandMap, HttpServletRequest request) throws Exception {
		...
		return "webpack/com/sec/rnc/EgovRlnmPinCnfirm";
	}
	...
	public String gpinCall(Model model, @RequestParam Map<String, Object> commandMap) throws Exception {
		...
		return "webpack/com/sec/rnc/gpin/Sample-AuthRequest";
	}
	...
	public String validate() {
		return "webpack/com/cmm/validator";
	}
	...
	public String moveToPage(@RequestParam("link") String linkPage) {
		...
		if (link == null || link.equals("")) {
			link = "webpack/com/cmm/egovError";
		}
