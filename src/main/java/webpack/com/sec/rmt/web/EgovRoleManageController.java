package webpack.com.sec.rmt.web;
...
import webpack.com.sec.ram.service.AuthorManageVO;
import webpack.com.sec.ram.service.EgovAuthorManageService;
import webpack.com.sec.rmt.service.EgovRoleManageService;
import webpack.com.sec.rmt.service.RoleManage;
import webpack.com.sec.rmt.service.RoleManageVO;
...
public class EgovRoleManageController {
    ...
    public String selectRoleListView()
            throws Exception {
        return "webpack/com/sec/rmt/EgovRoleManage";
    }
	...
	public String selectRole(@RequestParam("roleCode") String roleCode,
        ...
        return "webpack/com/sec/rmt/EgovRoleUpdate";
	}
    ...
    public String insertRoleView(@ModelAttribute("authorManageVO") AuthorManageVO authorManageVO,
        ...
        return "webpack/com/sec/rmt/EgovRoleInsert";
    }
