...
INSERT INTO `tb_board_notice` VALUES ('NOTI_000000000000221','고정 공지사항입니다.','<p>하핫</p>',5,NULL,'Y','USER','2023-05-11 23:58:57',NULL,NULL),('NOTI_000000000000241','단편동화','<p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">옛날 어떤</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">마을에 가난한 훈장님이 있었다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">어느날</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">이 훈장님이 생일을 맞았는데, 생일을</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">차려줄 가족들이 없었다.</span></p><p style=\"margin-left:0px;\">​</p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">그래서</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">서당 아이들이 훈장님을 위해 술잔치를</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">마련하기로 했어.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">\"우리</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">모두 집에서 술을 한 되씩</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">가져오자.\"</span></p><p style=\"margin-left:0px;\">&nbsp;</p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">\"그래,</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">그렇게 해서 한 되 한 되 모이면,</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">나중에는 큰 독에 가득찰거야.\"</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">드디어</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">훈장님의 생일날이 됐다.</span></p><p style=\"margin-left:0px;\">​</p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">아이들은</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">약속한 대로 술을 조금씩 모아서,</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">큰 독을 한가득 채워놨다.</span></p><p style=\"margin-left:0px;\">&nbsp;</p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">이걸</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">보고 동네 어른들도 칭찬을</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">아끼지 않았다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">\"참 기특하기도 하구나.\"</span></p><p style=\"margin-left:0px;\">&nbsp;</p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">하지만</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">잔치가 시작되고, 어른들이 술을 한 잔씩</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">마신 뒤에 참 이상한 일이 벌어졌다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">\"어라, 술맛이 왜 이렇지?\"</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">\"쩝쩝....이건 그냥 맹물이잖아.\"</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">어른들</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">말대로술에서는 술냄새가 하나도</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">나지 않았다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">이걸 보고</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">한 아이가 속으로 생각했지.</span></p><p style=\"margin-left:0px;\">​</p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">\'이상하다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">내가 아까 술 대신 맹물을</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">부었는데,</span></p><p style=\"margin-left:0px;\">​</p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">그것 때문에</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">다른 애들이 가져온 술까지 모두</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">맹물이 되었나?\'</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">그 아이는</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">다른 아이들이 술을 부을 때, 몰래</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">물을 부었던 거다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">나 하나쯤이야 하는</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">생각을 했던 아이는 너무나 부끄러워</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">고개를 들 수 없었다.</span></p><p style=\"margin-left:0px;\">&nbsp;</p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">하지만</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">그렇게 생각한 건 다른 아이들도</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">마찬가지였다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">동네사람들이</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">어찌된 일인지 짐작을 하며 수군거리기</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">시작했고,</span></p><p style=\"margin-left:0px;\">​</p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">훈장님은</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">웃으며,아이들이 마련한 잔치를</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">즐기자 하셨다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">이렇게 해서</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">즐겁고 신나는 맹물 잔치를</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">벌였단다.</span></p><p style=\"margin-left:0px;\">&nbsp;</p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\"><strong>2. 누워서 먹고 사는 사람</strong></span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\"><strong>- 게으름뱅이의 깨달음</strong></span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">옛날</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">어떤 마을에 지독한 게으름</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">뱅이가 살았다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">너무너무</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">게을러서,밥 먹을 때도 아내가 떠</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">먹여 줘야 할 정도였다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">이렇게</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">아무일도 하지 않고 방에만 누워 있으니,</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">집안이 점점 더 가난해져 갔다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">하루는이 게으름뱅이가</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">곰곰이 생각하기를, 누워 있기만 해도 잘 먹고</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">잘 사는 방법이 없을까 하는 거였다.</span></p><p style=\"margin-left:0px;\">​</p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">그래</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">점쟁이를 찾아갔더니,</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">\"당신은 정말 복을 타고났소이다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">가만히 누워 있기만 해도, 저절로 먹고 살 수 있겠구려.\"</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​하는 거였다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">덩실덩실</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">춤을 추며 집으로 왔다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">어느 날</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">게으름뱅이는 커다란 배나무 밑을</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">지나가게 됐다.</span></p><p style=\"margin-left:0px;\">​</p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">문득</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">위를 올려다보니,탐스런 배가 주렁주렁</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">열려 있었다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">\'옳거니,</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">저 배맛 좀 보자.\'</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">게으름뱅이는</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">그렇게 생각하고,배나무 밑에 입을 쫙</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">벌리고 드러누웠다.</span></p><p style=\"margin-left:0px;\">​</p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">이렇게 하고</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">있으면저절로 배가 떨어져서 입 안으로</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">쏙 들어올 것 같았다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">하지만</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">아무리 기다려도,그놈의 배는 엉뚱한</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">곳으로만 뚝뚝 떨어지네.</span></p><p style=\"margin-left:0px;\">​</p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">게으름뱅이</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">입 속으로는 영 들어오질 않고</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">말이다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">그때 게으름뱅이의</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">삼촌이 나타나서 손으로 따지 않고 배맛을 보려</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">한다며 호통을 치셨다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">게으름뱅이는</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">할 수 없이 일어나서 나무 위로 올라가</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">배를 뚝 따서 먹었다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">손수 따먹는 게</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">조금 귀찮기는 했지만, 입을 벌리고 누워만 있는</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">것보단 훨씬 빠르고 좋았다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">이제 해가</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">바뀌고 봄이 되어, 농사를 지어야</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">할 때가 됐다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">남들은 모두 논밭에</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">나가 열심히 일을 하는데, 게으름뱅이는 마냥</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">집안에 틀어박혀 누워만 지냈다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">그러자</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">또다시삼촌이 찾아와 꾸지람을</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">하셨다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">\"이 녀석아!</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">아무리 누워서 먹고 살 팔자라도, 사람이 제 구실을</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">하려면 땀을 흘려야지.</span></p><p style=\"margin-left:0px;\">​</p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">당장</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">나가서 일하지 못해!\"</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">게으름뱅이는</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">할 수 없이 들에 나가 일을 했다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">밭을 갈고,</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">씨를 뿌리고,거름을 주고....</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">그렇게</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">부지런히 일하다 보니,아주 재미없고</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">힘들기만 한 건 아니었다.</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">​</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">가을에는</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">게으름뱅이네 밭에도 풍년이 들어</span></p><p style=\"margin-left:0px;\"><span style=\"color:rgb(0,0,0);\">잘 살게 되었다.</span></p><p>&nbsp;</p>',2,NULL,'N','USER','2023-11-09 22:14:36',NULL,NULL);
...
INSERT INTO `tb_com_menuinfo` VALUES ('root','dir',0,0,1,'root','/','/'),('콘텐츠 제작','텍스트 콘텐츠',1000,0,1,'','/','/'),('텍스트 콘텐츠','텍스트 콘텐츠',1010,1000,2,'텍스트 콘텐츠 관리','/','/'),('동영상 콘텐츠','동영상 컨텐츠',1020,1000,3,'동영상 콘텐츠','/','/'),('게시판','공지사항 게시판',2000,0,1,'게시판','/','/'),('공지사항','공지사항 게시판',2010,2000,1,'','/','/'),('질문게시판','임시메뉴생성용',2020,2000,2,'질문게시판','/','/');
...
INSERT INTO `tb_com_menucreat` VALUES (1000,'ROLE_USER',NULL),(1010,'ROLE_USER',NULL),(1020,'ROLE_USER',NULL),(2000,'ROLE_USER',NULL),(2010,'ROLE_USER',NULL),(2020,'ROLE_USER',NULL);
