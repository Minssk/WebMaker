...
#
# Structure for table "tb_modal_btn"
#

DROP TABLE IF EXISTS `tb_modal_btn`;
CREATE TABLE `tb_modal_btn` (
  `btn_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '버튼 ID',
  `md_code` int(11) DEFAULT NULL COMMENT '모달 코드',
  `btn_order` int(11) NOT NULL DEFAULT 0 COMMENT '버튼 순서',
  `btn_type` varchar(20) DEFAULT NULL COMMENT '버튼 타입',
  `btn_text` varchar(255) DEFAULT NULL COMMENT '버튼 텍스트',
...
CREATE TABLE `tb_modal_tmp` (
  ...
  `md_role` varchar(20) DEFAULT NULL COMMENT '사용자 권한 타입',
  PRIMARY KEY (`md_code`)
...
INSERT INTO `tb_modal_tmp` VALUES (0,'경고','오류가 발생했습니다.',NULL,'alert','user'),(1,'알림','개발자 모드를 사용중입니다.','본 플랫폼에서는 작가님들을 위한 저작권보호 정책으로 개발자모드를 차단하고있습니다. F12를 눌러 개발자모드를 꺼주시기 바랍니다.','alert','user'),(2,'알림','게시글을 등록했습니다.','요청하신 게시글 등록을 완료했습니다.','alert','user'),(3,'알림','게시글을 수정했습니다.','요청하신 게시글 수정을 완료했습니다.','alert','user'),(4,'알림','게시글을 삭제했습니다.','요청하신 게시글 삭제를 완료했습니다.','alert','user');
