...
<link type="text/css" rel="stylesheet" href="<c:url value='/css/webpack/com/com.css' />">
<link type="text/css" rel="stylesheet" href="<c:url value='/css/webpack/com/uat/uia/login.css' />">
<script type="text/javascript" src="<c:url value='/js/webpack/com/cmm/showModalDialog.js'/>" ></script>
<script type="text/javascript" src="<c:url value='/js/webpack/com/cmm/jquery.js'/>" ></script>
...
<div class="login_form">
	...
	<fieldset>
		<img src="<c:url value='/images/webpack/com/uat/uia/login_tit.png'/>" style="margin:30px 0 0px 60px" alt="login title image"  title="login title image">
	...
	<a href="${ naver_url }"><img width="300" src="<c:url value='/images/webpack/com/uat/uia/naver-login.png'/>" alt="Naver Login" /></a>
	<br><br>
	<a href="${ google_url }"><img width="300" src="<c:url value='/images/webpack/com/uat/uia/google-login.png'/>" alt="Google Login" /></a>
	<br><br>
	<a href="${ kakao_url }"><img width="300" src="<c:url value='/images/webpack/com/uat/uia/kakao-login.png'/>" alt="Kakao Login" /></a>
