...
<body onload="fn_egov_init()">
	...
	<p/>
	<b><img src="${pageContext.request.contextPath }/images/webpack/com/cmm/icon/tit_icon.png"> <spring:message code="comCmm.expirePwdContent.22"/> </b><p/><!-- 비밀번호 유효기간 만료 -->
	...
	<br /><b><img src="${pageContext.request.contextPath }/images/webpack/com/cmm/icon/tit_icon.png"> <spring:message code="comCmm.expirePwdContent.25"/></b><p/><!-- 비밀번호 유효기간 초과일수 -->
