...
<tr><td>
		...
		<tr>
	<!--	    <td><center><img src="<c:url value='/images/webpack/com/uat/uia/logo.gif' />" alt="" border="0"></center></td> -->
		</tr>
		<tr>
		    <td align="center"><br><img src="<c:url value='/images/webpack/com/uat/uia/dot_line.gif' />" alt="" width="360" height="10" border="0"></td>
		</tr>
		<tr>
		...
		<tr><td align="center">
		<a href='/html/webpack/com/uat/uia/setup/install_on_v1.0.4.9.exe'><img src="<c:url value='/images/webpack/com/uat/uia/security_down.gif' />" width="136" height="29" alt="" border="0"></a>
		</td>
		</tr>
</table>
</td></tr></table>
...
if(HaveObject()) {
	...
	location.href = "/html/webpack/com/uat/uia/setup/install_off_v1.0.2.8.exe";
}
-->
</Script>
<br>
