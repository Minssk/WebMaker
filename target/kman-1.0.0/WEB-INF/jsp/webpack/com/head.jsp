...
<script language="text/javascript" src="<c:url value='/js/webpack/com/main.js' />"></script>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/webpack/com/main_portal.css' />">
<style type="text/css">
...
<link type="text/css" rel="stylesheet" href="/egovframework-all-in-one/css/webpack/com/cmm/jqueryui.css">
...
<input name="vStartP" type="hidden" />
    <div id="gnb">
    <div id="top_logo"><a href="<c:url value='/sym/mnu/mpm/EgovMainMenuHome.do' />" target=_top><img src="<c:url value='/images/webpack/com/cmm/main/logo_01.gif' />" alt="egovframe" /></a></div>
    <div id="use_descri">
            <ul>
                <li><spring:message code="comSymMnuMpm.head.head"/></li><!-- 공통서비스 테스트 사이트 -->
                <li><a href="javascript:actionLogout()"><img src="<c:url value='/images/webpack/com/cmm/main/logout_btn.gif' />" alt="로그아웃" /></a></li>
            </ul>
    </div>
    </div>
    <div id="new_topnavi">
