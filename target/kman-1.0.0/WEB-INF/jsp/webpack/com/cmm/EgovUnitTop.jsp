...
<link type="text/css" rel="stylesheet" href="<c:url value='/css/webpack/com/cmm/main.css' />">
...
<div id="header">
	<div class="header_box">
		<h1>
			<a href="<c:url value='/EgovContent.do' />" target="_content"><img src="<c:url value='/images/webpack/com/cmm/main/top_logo.png' />" alt="eGovframe"></a>
		</h1>
