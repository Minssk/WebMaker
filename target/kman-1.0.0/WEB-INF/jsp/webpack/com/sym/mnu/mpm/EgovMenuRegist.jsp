...
<c:set var="ImgUrl" value="${pageContext.request.contextPath}/images/webpack/com/sym/mnu/mpm/"/>
<html lang="ko">
<head>
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<a id="popupUpperMenuId" href="<c:url value='/sym/mnu/mpm/EgovMenuListSelectMvmn.do' />" target="_blank" title="<spring:message code="comSymMnuMpm.menuRegist.newWindow"/>"><img src="<c:url value='/images/webpack/com/cmm/icon/search2.gif' />"
		...
		<tr>
			...
			<td class="left" colspan="3">
		        ...
		        <a id="popupProgrmFileNm" href="<c:url value='/sym/prm/EgovProgramListSearch.do'/>?tmp_SearchElementName=progrmFileNm" target="_blank" title="<spring:message code="comSymMnuMpm.menuRegist.newWindow"/>">
					<img src="<c:url value='/images/webpack/com/cmm/icon/search2.gif' />" alt='' />(<spring:message code="comSymMnuMpm.menuRegist.programFileNameSearch"/>)</a><!-- 새창으로 --><!-- 프로그램파일명 검색 -->
			</td>
		</tr>
		<tr>
