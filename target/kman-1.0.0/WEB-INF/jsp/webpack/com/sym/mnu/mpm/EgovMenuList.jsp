...
<%
//String imagePath_icon   = "/images/webpack/com/sym/mnu/mpm/icon/";
//String imagePath_button = "/images/webpack/com/sym/mnu/mpm/button/";
%>
<html lang="ko">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title><spring:message code="comSymMnuMpm.menuList.title" /></title>
<link href="<c:url value="/css/webpack/com/com.css"/>" rel="stylesheet" type="text/css">
<link href="<c:url value="/css/webpack/com/button.css"/>" rel="stylesheet" type="text/css">
<script type="text/javascript" src="<c:url value="/validator.do" />"></script>
<script type="text/javascript">
var imgpath = "<c:url value='/images/webpack/com/cmm/utl/'/>";
</script>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/webpack/com/cmm/jqueryui.css' />">
<script src="<c:url value='/js/webpack/com/cmm/jquery.js' />"></script>
<script src="<c:url value='/js/webpack/com/cmm/jqueryui.js' />"></script>

<script language="javascript1.2" type="text/javaScript" src="<c:url value='/js/webpack/com/sym/mnu/mpm/EgovMenuList.js' />"></script>
...
<%-- <table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <h1><img src="<c:url value='/images/webpack/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="">&nbsp;메뉴 목록</h1></td>
 </tr>
</table> --%>
   ...
   <td style="vertical-align:top">
		...
		<table class="wTable" >
		  ...
		  <tr>
	        ...
	        <a id="popupUpperMenuId" href="/sym/mnu/mpm/EgovMenuListSelectMvmn.do" target="_blank" title="<spring:message code="comSymMnuMpm.menuList.upperMenuId" />" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/webpack/com/cmm/icon/search2.gif' />"
		  ...
		  <tr>
	        ...
	        <a id="popupProgrmFileNm" href="/sym/prm/EgovProgramListSearch.do" target="_blank" title="<spring:message code="comSymMnuMpm.menuList.progrmFileNm" />" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/webpack/com/cmm/icon/search2.gif' />"
