...
<%
  ...
  */
  ...
  /* Image Path 설정 */
//  String imagePath_icon   = "/images/webpack/com/sym/mnu/stm/icon/";
//  String imagePath_button = "/images/webpack/com/sym/mnu/stm/button/";
%>
<html lang="ko">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" >
<link rel="stylesheet" href="<c:url value='/css/webpack/com/com.css' />" type="text/css">
<link rel="stylesheet" href="<c:url value='/css/webpack/com/button.css' />" type="text/css">
<title>메뉴생성</title>
<style type="text/css">
	h1 {font-size:12px;}
