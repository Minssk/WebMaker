...
<script language="javascript1.2" type="text/javaScript" src="<c:url value='/js/webpack/com/sym/mnu/mcm/EgovMenuCreatSiteMap.js' />"></script>
...
//var vSiteMapPath = "/html/webpack/com/sym/mnu/mcm/";
