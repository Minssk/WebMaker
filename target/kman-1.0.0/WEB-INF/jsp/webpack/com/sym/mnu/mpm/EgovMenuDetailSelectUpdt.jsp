...
<c:set var="ImgUrl" value="/images/webpack/com/sym/mnu/mpm/"/>
<head>
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<a id="popupUpperMenuId" href="<c:url value='/sym/mnu/mpm/EgovMenuListSelectMvmn.do' />" target="_blank" title="<spring:message code="comSymMnuMpm.menuDetailSelectUpdt.newWindow"/>"><img src="<c:url value='/images/webpack/com/cmm/icon/search2.gif' />"
		...
		<tr>
			...
			<td class="left" colspan="3">
		        ...
		        <a id="popupProgrmFileNm" href="<c:url value='/sym/prm/EgovProgramListSearch.do' />" target="_blank" title="<spring:message code="comSymMnuMpm.menuDetailSelectUpdt.newWindow"/>"><img src="<c:url value='/images/webpack/com/cmm/icon/search2.gif' />"
