...
<link type="text/css" rel="stylesheet" href="<c:url value='/css/webpack/com/cop/bbs/style.css' />">
...
<!-- 상단 타이틀  영역 -->
  ...
  <c:if test="${searchList == '1'}">
   <img src="<c:url value='/images/webpack/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;${titleZip }</h1></td>
  </c:if>
  <c:if test="${searchList == '2'}">
   <img src="<c:url value='/images/webpack/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;${titleRdmn }</h1></td>
  </c:if>
